...
| 6 | [`crying-detection-s3-ml-alternatives.md`](crying-detection-s3-ml-alternatives.md) | ML approaches for baby-cry detection on S3 that the sibling C6 project (`ws-ESP32-C6-Touch-AMOLED-1.8/14-crying-detection-research.md`) had to reject due to resource limits: pretrained YAMNet, ESP-SR AFE, multi-modal audio+vision, beamforming. Training-free shortlist included |
